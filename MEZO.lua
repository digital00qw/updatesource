...
ControllerAll = false
local ListSudos ={Sudo_Id,1833610203,1001132193,1673741057}  
...
if UserId == 1833610203 then
Status = '☬ • 𝘋𝘌𝘝 𝘊𝘙𝘐𝘚𝘛𝘐𝘕 • ☬'
elseif UserId == 1001132193 then  
Status = 'الـمـطـور بـارلـو'
elseif UserId == 1673741057 then  
Status = 'الـمـطـور نـيـورك'
...
return{
BanAll = Redis:sismember(MEZO.."MEZO:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(MEZO.."MEZO:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(MEZO.."MEZO:BanGroup:Group"..ChatId,UserId) ,
...
local msg_id = msg.id
Redis:incr(MEZO..'MEZO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == 1833610203 then
msg.Name_Controller = '☬ • 𝘋𝘌𝘝 𝘊𝘙𝘐𝘚𝘛𝘐𝘕 • ☬'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1001132193 then
msg.Name_Controller = 'الـمـطـور بـارلـو'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1673741057 then
msg.Name_Controller = 'الـمـطـور نـيـورك'
msg.The_Controller = 1
...
local Num_Msg_Max = Redis:hget(MEZO.."MEZO:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
...
Num_Msg_Max = Redis:hget(MEZO.."MEZO:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
Redis:incr(MEZO.."MEZO:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(MEZO.."MEZO:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(MEZO.."MEZO:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(MEZO.."MEZO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(MEZO.."MEZO:Lock:Contact"..msg_chat_id)
...
if Redis:get(MEZO.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(MEZO.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(MEZO.."MEZO:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(MEZO.."MEZO:Change:Name:Bot"..msg.sender.user_id) 
...
--download('https://raw.githubusercontent.com/digital00qw/updatesource/master/MEZO.lua','MEZO.lua')
...
Get_Json = Get_Json..'"Dev":"O0o_marshmloo_o0O"}'
end
Get_Json = Get_Json..'}}'
...
NamesBot = (Redis:get(MEZO.."MEZO:Name:Bot") or "لنيورك")
...
local NumberGames = Redis:get(MEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(MEZO.."MEZO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(MEZO.."MEZO:Set:Id:Groups") or Redis:get(MEZO.."MEZO:Set:Id:Group"..msg_chat_id)
...
local Info_Members = Redis:smembers(MEZO.."MEZO:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MEZO.."MEZO:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(MEZO.."MEZO:Zhrf:Sasa"..msg_chat_id,true) 
...
Redis:set(MEZO.."MEZO:Status:BanId"..msg_chat_id,true) 
...
Redis:del(MEZO.."MEZO:Zhrf:Sasa"..msg_chat_id) 
...
Redis:del(MEZO.."MEZO:Status:BanId"..msg_chat_id) 
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج احمد المصري' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ◉ عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Redis:sismember(MEZO.."MEZO:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ◉ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(MEZO.."MEZO:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(MEZO.."MEZO:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(MEZO.."MEZO:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ◉ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ◉ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج احمد المصري' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ◉ عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if Redis:sismember(MEZO.."MEZO:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(MEZO.."MEZO:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(MEZO.."MEZO:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(MEZO.."MEZO:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,UserId) == 'المبرمج احمد المصري' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  ◉ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'مبرمج السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  ◉ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
...
if Redis:sismember(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ◉ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ◉ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(MEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:get(MEZO.."MEZO:Status:BanId"..msg.chat_id)  then
...
data = {
{
{text = '⧫ 𝘊𝘙𝘐𝘚𝘛𝘐𝘕 • 𝘚𝘖𝘜𝘙𝘊𝘌 ⧫', url = 't.me/cristin_so'}, 
},
}
}
...
local Text = "*\n ◉ اعدادات المجموعه ".."\n✔️︙علامة صح تعني انا الامر مفتوح".."\n✖️︙علامة غلط تعني انا الامر مقفول*"
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد جهاتك يبشا ⇦ '..(Redis:get(MEZO.."MEZO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:del(MEZO.."MEZO:BanAll:Groups") 
...
Redis:del(MEZO.."MEZO:BanGroup:Group"..msg_chat_id) 
...
local TextingDevMEZO = Redis:get(MEZO..'MEZO:Texting:DevMEZO')
if TextingDevMEZO then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevMEZO,"md",true)  
else
...
if text == 'تستسنسنستستستستسستستست'  then
local TextingDevMEZO = Redis:get(MEZO..'MEZO:Texting:DevMEZO')
if TextingDevMEZO then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevMEZO,"md",true)  
else
...
elseif text == 'Dev' or text == 'Devlo' or text == '☬ • 𝘋𝘌𝘝 𝘊𝘙𝘐𝘚𝘛𝘐𝘕 • ☬' then
photo = "https://t.me/LogOoNB/102"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ☬ • 𝘋𝘌𝘝 𝘊𝘙𝘐𝘚𝘛𝘐𝘕 • ☬ \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '☬ • 𝘋𝘌𝘝 𝘊𝘙𝘐𝘚𝘛𝘐𝘕 • ☬', url = "https://t.me/O0o_marshmloo_o0O"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'بارلو' or text == 'Barlo' or text == 'مبرمج السورس' then
photo = "https://t.me/LogOoNB/101"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ • 𝘋𝘌𝘝 𝘉𝘈𝘙𝘓𝘖 • \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '☬ • 𝘋𝘌𝘝 𝘉𝘈𝘙𝘓𝘖 • ☬', url = "https://t.me/bar_lo0o0"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'كرستين' or text == 'كرستينا' or text == 'جيرسي' then
photo = "https://t.me/LogOoNB/103"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ঌ ᴄʀɪѕᴛɪɴ • ঌ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 💅💛 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '☬ • 𝘋𝘌𝘝 𝘊𝘙𝘐𝘚𝘛𝘐𝘕 • ☬ঌ', url = "https://t.me/O0o_marshmloo_o0O"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '《𝟓》', data = msg.sender.user_id..'/listallAddorrem'}, {text = '《𝟔》', data = msg.sender.user_id..'/NoNextSeting'}, 
},
{
{text = '⧫ 𝘊𝘙𝘐𝘚𝘛𝘐𝘕 • 𝘚𝘖𝘜𝘙𝘊𝘌 ⧫', url = 't.me/cristin_so'}, 
},
...
return LuaTele.sendText(msg_chat_id,msg_id,'◉ اليك قسم الالعاب من سورس لنيورك ◉',"md",false, false, false, false, reply_markup)
end
...
data = {
{
{text = '◍S𝘰𝘶??𝘤𝘦 N𝘦𝘺𝘰𝘳𝘬 🖤𖤣', url = 't.me/cristin_so'}, 
},
}
}
...
Redis:setex(MEZO.."MEZO:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local NamesBot = (Redis:get(MEZO.."MEZO:Name:Bot") or "لنيورك")
local BotName = {
...
if text == (Redis:get(MEZO.."MEZO:Name:Bot") or "لنيورك") then
local photo = LuaTele.getUserProfilePhotos(MEZO)
local ban = LuaTele.getUser(MEZO)
for Name_User in string.gmatch(ban.first_name, "[^%s]+" ) do
ban.first_name = Name_User
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس لنيورك؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس لنيورك؟ ", 
"كم مره حبيت؟ ", 
...
if not msg.ControllerBot then
if not Redis:get(MEZO.."MEZO:Start:Bot") then
local CmdStart = '*\n ◉ أهلآ بك في بوت '..(Redis:get(MEZO.."MEZO:Name:Bot") or "لنيورك")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(MEZO.."MEZO:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
if not msg.ControllerBot then
if Redis:get(MEZO.."MEZO:TwaslBot") and not Redis:sismember(MEZO.."MEZO:BaN:In:Tuasl",msg.sender.user_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MEZO.."MEZO:photo:Rank"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MEZO.."MEZO:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MEZO.."MEZO:photo:Rank"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MEZO.."MEZO:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
Redis:srem(MEZO.."MEZO:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(MEZO.."MEZO:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MEZO.."MEZO:BanGroup:Group"..ChatId) 
